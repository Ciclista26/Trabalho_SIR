<div id="sidebar" class="sidebar active d-flex">
    <div>
        ...
        <div class="opcoes_user d-flex pb-3 al-c jc-between" >
            <div>
                <a class="navbar-brand al-c icon-c d-flex" href="../pages/secure/">
        ...
        <div class="opcoes_user d-flex pb-3 al-c jc-between">
            <div>
                <a class="navbar-brand al-c icon-c d-flex" href="../pages/secure/admin/">
    ...
    <div>
        ...
        <div class="perfil d-flex pb-3 al-c jc-between">
            <a class="navbar-brand al-c icon-c d-flex" href="../pages/secure/user/profile.php">
        ...
        <div class="logout d-flex al-c jc-between">
            <form class="logoutForm d-block" action="../controllers/auth/signin.php" method="post">
                <a class="navbar-brand al-c icon-c d-flex">
