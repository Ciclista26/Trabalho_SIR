<div id="sidebar" class="sidebar active d-flex">
    <div>
        <div class="opcoes_user d-flex pb-3 al-c jc-between" onclick="toggleSidebar()">
            <div>
        ...
        <div class="opcoes_user d-flex pb-3 al-c jc-between" >
            <div>
                <a class="navbar-brand al-c icon-c d-flex" href="/Trabalho_SIR/pages/secure/">
        ...
        <div class="opcoes_user d-flex pb-3 al-c jc-between">
            <div>
                <a class="navbar-brand al-c icon-c d-flex" href="/Trabalho_SIR/pages/secure/admin/">
                    ...
                    <div class="m-0 te_2 d-none pl-1">Utilizadores</div>
                </a>
            </div>
        </div>
        ';
    ...
    <div>
        <hr class="linha-tracejada">
        <div class="perfil d-flex pb-3 al-c jc-between">
            <a class="navbar-brand al-c icon-c d-flex" href="/Trabalho_SIR/pages/secure/user/profile.php">
                ...
                <div class="m-0 te_3 d-none pl-1">Profile</div>
            </a>
        </div>
        <div class="logout d-flex al-c jc-between">
            <form class="logoutForm d-block" action="/Trabalho_SIR/controllers/auth/signin.php" method="post">
                <a class="navbar-brand al-c icon-c d-flex">
                    <button class="logout al-c  nav-link d-flex" type="submit" name="user" value="logout">
                        ...
                        <div class="m-0 te_4 d-none pl-1">Terminar sessão</div>
                    </button>
                </a>
            </form>
        </div>
