...
<main>
    <header class="pb-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center text-dark text-decoration-none"><img
                src="/Trabalho_SIR/assets/images/logo-estg.svg" alt="ESTG" class="mw-100"></a>
    </header>
    ...
    <div class="row align-items-md-stretch">
        <div class="col-md-6">
            <div class="h-100 p-5 text-bg-dark rounded-3">
                <h2>Profile</h2>
                <a href="/Trabalho_SIR/pages/secure/user/profile.php"><button class="btn btn-outline-light px-5"
        ...
        if (isAuthenticated() && $user['administrator']) {
            echo '<div class="col-md-6">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                        <h2>Admin</h2>
                        <a href="/Trabalho_SIR/pages/secure/admin/"><button class="btn btn-outline-success" type="button">Admin</button></a>
                    </div>
                </div>';
        }
        ?>
