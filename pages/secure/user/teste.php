                ...
                <div class="m-0 p-3 ">
                    <div class="w-100 d-sm-flex col-12 ">
                        ...
                        <div class="col-12 col-lg-2 col-sm-4 p-0">
                            <a class="btn w-100 btn-secondary" href="/Trabalho_SIR/pages/secure/user/criar_votacao.php" role="button">Criar Votacao</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row m-3">
                                    <div class="col-12 p-0 mb-md-0">
                                        <div class="card-body-table">
                                            <h5 class="card-title"><?= $votacoes['nome_votacao'] ?></h5>
                                            <p class="card-text mb-0"><?= $votacoes['objetivo_votacao'] ?></p>
                                            <div class="col-12 mt-3 p-0 d-flex space-around al-c">
                                                <a href="/Trabalho_SIR/pages/secure/user/resp_votacao.php?<?= 'votacao=update&id=' . $votacao['id_votacao'] ?>">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <?= $votacoes['nome_votacao'] ?>
                                    </td>
                                    <td>
                                        <?= $votacoes['objetivo_votacao'] ?>
                                    </td>
                                    <td>
                                        <div class="d-flex space-around">
                                            <a href="/Trabalho_SIR/controllers/user/votacao.php?<?= 'votacao=update&id=' . $votacoes['id_votacao'] ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                                </svg>
                                            </a>
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete<?= $votacoes['id_votacao'] ?>">
                                ...
                                <div class="modal fade" id="delete<?= $votacoes['id_votacao'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn col-12 col-xl-3 col-md-4 col-sm-5 me-sm-3 mb-3 mb-sm-0 btn-warning-yellow" href="/Trabalho_SIR/controllers/user/votacao.php?<?= 'votacao=delete&id=' . $votacoes['id_votacao'] ?>">Confirmar</a>
