            ...
            <div class="p-5 mb-4 bg-body-tertiary rounded">
                <div class="container-fluid py-5 ">
                    ...
                    <div class="d-flex justify-content">
                        <a href="/Trabalho_SIR/pages/public/signin.php"><button class="btn btn-success btn-lg px-5 me-2">Sign
                                In</button></a>
                        <a href="/Trabalho_SIR/pages/public/signup.php"><button class="btn btn-info btn-lg px-4">Sign
                                Up</button></a>
                    </div>
                </div>
            </div>
